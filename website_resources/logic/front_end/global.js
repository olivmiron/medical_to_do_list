...
function initialize_main_steps() {
    ...
    if(!main_steps.initialized) {
        main_steps = {
            initialized: true,
            no_due_date: 0,
            one_day: parseInt(get_calc_css_value_of_variable("--due_date_picker_reference_size")) + parseInt(get_calc_css_value_of_variable("--spacing_medium")) + 2,
            ten_days: parseInt(due_date_container.clientWidth) - parseInt(get_calc_css_value_of_variable("--due_date_picker_reference_size")) + 2
        };
    }
}
